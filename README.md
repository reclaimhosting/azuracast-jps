...
## Configuration for use with Reclaim Cloud's Shared Load Balancer
...
After that, you will need to access the SSH terminal and run the following commands to enable the SSL certificate for the newly mapped domain:
```
cd /var/azuracast
